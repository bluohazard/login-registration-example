                        ...
                        <div class="container">
                            <form action="../process/inputProcess.php" method="post">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label mr-3">
                                            <input type="radio" class="form-check-input" name="jenis_kelamin"
                                                id="jenis_kelamin" value="Laki-Laki">Laki-Laki
                                        </label>
                                ...
                                if(isset($_GET["error"])) 
                                {
                                    $error = $_GET["error"];
                                ?>
                                <small class="rounded border border-danger text-danger align-self-start p-1 d-flex"
                                    id="error-handling2">
                                <?php
                                    echo $error;
                                }
                                ...
                                ?>
                                <small class="rounded border border-success text-success align-self-start p-1 d-flex"
                                    id="error-handling2">
                                <?php
                                    echo $message;
                                }
